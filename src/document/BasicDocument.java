...
public class BasicDocument extends Document 
{
	...
	System.out.println(s);
		String test = "This is a test.  How many???  "+ "Senteeeeeeeeeences are here... there should be 5!  Right?";
		Document testNumWords = new BasicDocument(test);
		System.out.println("testNumWords = "+testNumWords.getNumWords());
		System.out.println("testNumSentences = "+testNumWords.getNumSentences());
